...
window.OMAN_PREMIUM = {
  ...
  "wadi-mibam": {
    ...
    guideNote: "Easier with someone who knows the way. DM me and I'll put you onto the guide I use."
  },
  ...
  "wadi-al-arbeieen": {
    ...
    guideNote: "The driving and the route-finding are the hard parts. handles both."
  },
  ...
  "wadi-ghul": {
    ...
    guideNote: "The track is the hard part, not the walking. Go with a driver who has done it before."
  },
  ...
  "wadi-hawer": {
    ...
    guideNote: "Don't do this one alone. Go with an operator who knows the line through the canyon."
  },
  ...
  "snake-gorge": {
    ...
    guideNote: "Non-negotiable: go with a guide. They bring the ropes and the helmets, and they know which pools are deep enough this season."
  },
  ...
  "bandar-khayran": {
    ...
    guideNote: "Easiest by boat. Operators running it: Mola Mola Diving Center, Coral Ocean Tours, and Husaak Adventures for the sunset kayak. Ask which cove they're heading to before you book."
  },
  ...
  "daymaniyat": {
    ...
    guideNote: "Boat tour only. Operators running it: Daymaniyat Tours, Muscat Sea Adventure, Mola Mola Diving Center, Cruiseboat Oman. Book direct and ask which sites they're snorkelling that morning."
  },
  ...
  "wahiba-sands": {
    ...
    guideNote: "Pick a camp. Ones running it: Oman Wahiba Sands Desert Tours, Magic Camps, Zahara Tours, Sunshine Tours. Whichever you choose, ask for a pitch away from the main road, that's the difference between stars and no stars."
  },
  ...
  "balad-sayt": {
    ...
    guideNote: "If the mountain road worries you, a guide-driver turns a white-knuckle day into a great one. does this loop well."
  },
  ...
  "musandam-dhow": {
    ...
    guideNote: "Dhow operators run from Khasab harbour, book ahead in peak season."
  },
  ...
  "food-halwa": {
    whatYoullDo: [
      "Buy from the stall that is actually stirring a pot, not the one with boxes stacked out front.",
  ...
  "shop-nizwa-souq": {
    ...
    tips: [
      "Silver is sold by weight plus workmanship, so ask what the piece weighs before you talk price.",
      "The pottery hall is calmer than the silver end, and the sellers there haggle less theatrically.",
      "Karak is cheapest at the small stalls on the car-park side, not the ones facing the fort."
    ],
    guideNote: ""
  },
  ...
  "wadi-al-khoudh": {
    ...
    whatYoullDo: [
      ...
      "The deeper pools sit further up the gorge; the first ones shrink to puddles by late spring.",
  ...
  "salma-plateau": {
    ...
    guideNote: "This is THE trip to do with someone who knows the plateau. runs it properly."
  },
  "jabrin-castle": {
    gettingThere: [
  ...
  "sugar-dunes": {
    ...
    guideNote: "First time on serious sand? Go with someone who's done it. runs Sugar Dunes trips."
  },
